...
ENTITY_TYPES = ("biomarker", "symptom", "condition", "intervention", "lifestyle", "event")
RELATIONSHIPS = ("causes", "correlates_with", "triggered_by", "worsens", "resolves", "indicates", "precedes")
